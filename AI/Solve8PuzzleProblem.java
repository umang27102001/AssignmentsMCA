...
import java.util.*;
public class Solve8PuzzleProblem {
    ...
    //Calculating h below. h is the deviation of initialState from goalState.
    ...
    // Below two functions check if the given Problem is Solvable or not.
    ...
    // Create a node for each new Matrix
    ...
    // These functions will print the Path from root to the end Using Recursion.
    ...
    // This comp is for the creation of PriorityQueue.
    ...
    // This function solves the 8 puzzleproblem , This is modified BFS or A* Algorithm. 
